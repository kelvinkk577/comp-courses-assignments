...
public class StringProcessingSystem {
    ...
    public static void split() {
        ...
        for (String split : originalText.split(target))
    ...
    public static void removeSubstring() {
        ...
        if (originalText.indexOf(target) != -1)
        	System.out.println("String after removing \'" + target + "\': " + originalText.replaceFirst(target, ""));
        else
    ...
    public static void shiftString() {
        ...
        shiftAmount %= len;
        modifiedText = originalText.substring(len-shiftAmount, len) + originalText.substring(0, len-shiftAmount);
    ...
    public static void countVowels() {
    	...
    	System.out.print("number of vowels in \"" + originalText + "\": ");
    	System.out.println(originalText.length() - modifiedText.length());
    }
    ...
    public static void ceaserCipher() {
        ...
        for (char c : originalText.toCharArray())
        	if (c >= 'A' && c <= 'Z')
        		if (c + shift > 'Z')
        			modifiedText += (char) (c + shift - 26);
        		else
        			modifiedText += (char) (c + shift);
        	else
        		modifiedText += c;
