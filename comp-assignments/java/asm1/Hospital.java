...
public class Hospital {
    ...
    public boolean addPatient(Patient patient) {
        switch (patient.getSymptomLevel()) {
	        ...
	        case Critical:
	        	return CriticalPatients.add(patient);
	        case Moderate:
	        	return ModeratePatients.add(patient);
	        case Mild:
	        	return MildPatients.add(patient);
            default:
                break;
        }
        return false;
    ...
    public boolean releasePatient(Patient patient) {
        switch (patient.getSymptomLevel()) {
            //TODO: handle three kinds of the symptom levels
	        case Critical:
	        	return CriticalPatients.remove(patient);
	        case Moderate:
	        	return ModeratePatients.remove(patient);
	        case Mild:
	        	return MildPatients.remove(patient);
            default:
                break;
        }
        return false;
